...
| Propose G4 security model | `docs/propose-g4-security` | `/private/tmp/portfolio-manager-worktrees/g4-security` | primary agent | G2 approved | integrating | 2026-08-05 |
